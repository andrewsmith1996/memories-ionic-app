...
@Component({
  selector: 'app-search-add-friend-modal',
  templateUrl: './search-add-friend-modal.page.html',
  styleUrls: ['./search-add-friend-modal.page.scss'],
})
export class SearchAddFriendModalPage implements OnInit {
